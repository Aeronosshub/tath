...
e.Image = "rbxassetid://17042591651"
e.Visible = true
local a = Instance.new("UICorner")
a.Name = "MCNR"
a.Parent = e
...
do
    if game:GetService("CoreGui"):FindFirstChild("WSkinnyUI") then
        game:GetService("CoreGui").WSkinnyUI:Destroy()
...
function a:Window(f, f, f)
    ...
    UiToggle_UiStroke1.Color = Color3.fromRGB(248, 248, 248)
    ...
    j.Position = UDim2.new(0, 25, 0.05, 0)
    ...
    k.Name = "Page"
    k.Parent = i
    k.BackgroundColor3 = Color3.fromRGB(0, 205, 255)
    ...
    function d:Tab(d, f)
        ...
        function a:Toggle(a, b, d)
            ...
            _G.TrueColor = Color3.fromRGB(255, 255, 255)
            local g = Instance.new("UICorner")
            ...
            o.Image = "rbxassetid://17211872809"
            j.Parent = h
        ...
        function a:Dropdown(a, b, d)
            ...
            f.Image = "rbxassetid://17211872809"
            k.Name = "DropTitle"
            k.Parent = g
        ...
        function a:Slider(a, c, d, e, g)
            ...
            l.Image = "rbxassetid://17211872809"
            m.Parent = j
        ...
        function a:Slider2(a, b, c, d, e)
            ...
            k.Image = "rbxassetid://17211872809"
            l.Parent = i
